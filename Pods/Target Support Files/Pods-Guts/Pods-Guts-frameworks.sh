...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ECPhoneNumberFormatter/ECPhoneNumberFormatter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIImageViewAligned/UIImageViewAligned.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UIView+BooleanAnimations/UIView_BooleanAnimations.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/XNGMarkdownParser/XNGMarkdownParser.framework"
fi
