...
extension ArtsyAPI : TargetType, ArtsyAPIType {
    var headers: [String : String]? {
        ...
        let defaultHeaders = ["Accept": "*/*","Content-Type":"application/json", "x-rings-ua": defaultUserAgent]
    ...
    var base: String { return "https://api-test.loopslive.com/1.0/" }
...
extension ArtsyAuthenticatedAPI: TargetType, ArtsyAPIType {
    ...
    var base: String { return "https://api.artsy.net" }
    var baseURL: URL { return URL(string: base)! }
